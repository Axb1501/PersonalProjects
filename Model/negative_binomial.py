    ...
    for train_index, test_index in kf.split(fixtures_df):
        ...
        for week in fixtures_df['Week'].unique():   
            ...
            for index, fixture in week_fixtures.iterrows():
                ...
                print(f"Home Teams: {home_team}, Away Teams: {away_team} Probability: {home_win_probability:.4f}, Home Win Probability: {away_win_probability:.4f}, draw: {draw_probability}")
        ...
        print(f"Fold {kf} - 'a' value: {a_value}, Overall Match Winner Accuracy: {overall_accuracy * 100:.2f}%")
...
a_values_to_try = [0.1]  # Adjust as needed
...
print(f"Corresponding Average Accuracy: {best_accuracy * 100:.2f}%")
